            ...
            <View >
                ...
                <View style={styles.SectionStyle}>
                  <TextInput
                        ...
                        right={passwordEye?<TextInput.Icon name="eye" onPress={()=>setPasswordEye(!passwordEye)} />:<TextInput.Icon name="eye" onPress={()=>setPasswordEye(!passwordEye)} />}
                  />
                </View>
                {errortext != '' ? (
                ...
                <View >
                 ...
                 <Text style={{textDecorationLine:'underline'}} onPress={() => navigation.navigate('Register')}> Register</Text>
